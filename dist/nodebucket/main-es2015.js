...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["app-home"]], decls: 29, vars: 1, consts: [["fxLayout", "row wrap"], ["fxFlex", ""], [1, "mat-elevation-z0", "main-list"], [1, "title"], ["fxLayout", "row"], ["fxLayout", "column", "fxFlex", "100%", 1, "new-task-forum"], [1, "subtitle"], ["method", "post", 3, "formGroup"], ["matInput", "", "formControlName", "text", "type", "text", "placeholder", "Enter Task...", 1, "task-input", 3, "keydown.enter"], [3, "click"], ["fxLayout", "column", "fxFlex", "50%", 1, "list", "todo-list"], [1, "item"], [1, "x-button"], ["src", "../../../assets/icons/x-symbol.svg", "alt", "Remove task item button", "height", "20", "width", "20", 1, "x-icon"], ["fxLayout", "column", "fxFlex", "50%", 1, "list"]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("keydown.enter", function HomeComponent_Template_input_keydown_enter_13_listener() { return ctx.newTask(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](14, "button", 9);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function HomeComponent_Template_button_click_14_listener() { return ctx.newTask(); });
